...
| 系统 | 安装包 | 说明 |
| --- | --- | --- |
| macOS | [`ScreenshotStitcher-macOS-arm64.dmg`](https://github.com/KwoYeung/ScreenshotStitcher/releases/download/v1.0.0/ScreenshotStitcher-macOS-arm64.dmg) | 适用于 Apple Silicon（M 系列芯片） |
| Windows | [`ScreenshotStitcher.exe`](https://github.com/KwoYeung/ScreenshotStitcher/releases/download/v1.0.0/ScreenshotStitcher.exe) | 适用于 Windows 10/11 |
...
1. 下载 `ScreenshotStitcher-macOS-arm64.dmg`。
...
6. 根据内容选择“自由平移画布”或“纵向长图”，然后开始拼接。自由平移模式会严格按导入顺序匹配，遇到第一个失败位置即停止并提示。
